...
The tests verify that both methods:
1. Complete without errors on static and variable geometry cases.
2. Produce forces within a reasonable tolerance of each other.
"""
...
class TestForceMethodsComparison(unittest.TestCase):
    """This is a class for comparing the Joukowski and Katz force calculation methods."""
    ...
    def test_static_geometry_methods_produce_similar_lift(self):
    ...
    def test_static_geometry_methods_produce_similar_drag(self):
        ...
        # Drag is the most sensitive quantity to force calculation method, so allow
        # 100% difference. This is expected because induced drag prediction is one
        # of the weakest aspects of panel methods.
    ...
    def test_static_geometry_methods_produce_similar_moment(self):
...
class TestForceMethodsVariableGeometry(unittest.TestCase):
    ...
    def test_variable_geometry_joukowski_completes(self):
    ...
    def test_variable_geometry_katz_completes(self):
